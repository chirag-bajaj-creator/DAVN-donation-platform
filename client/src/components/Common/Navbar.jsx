            ...
            {isAuthenticated && user ? (
              ...
              <>
                <div className="hidden sm:flex items-center space-x-2">
                  <Link
                    to="/login"
                    className="px-3 py-2 rounded-md text-sm font-medium text-gray-100 hover:bg-primary-700 transition-colors"
                  >
                    Login
                  </Link>
                  <Link
                ...
                <button
                  onClick={() => setIsMenuOpen(!isMenuOpen)}
                  className="sm:hidden p-2 rounded-md hover:bg-primary-700 transition-colors"
                >
                  <svg
                    className="w-6 h-6"
                    fill="none"
